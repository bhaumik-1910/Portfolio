                    ...
                    >
                        ...
                        <div className="contact__socials">
                            <motion.a
                                ...
                                className="social-btn social-btn--linkedin glass-card"
                                aria-label="LinkedIn"
                                target="_blank"
                                rel="noopener noreferrer"
                                whileHover={{ scale: 1.1, y: -4, rotate: 4 }}
                                whileTap={{ scale: 0.95 }}
                            >
                            ...
                            <motion.a
                                ...
                                className="social-btn social-btn--github glass-card"
                                aria-label="GitHub"
                                target="_blank"
                                rel="noopener noreferrer"
                                whileHover={{ scale: 1.1, y: -4, rotate: -4 }}
                            ...
                            <motion.a
                                ...
                                className="social-btn social-btn--whatsapp glass-card"
                                aria-label="WhatsApp"
                                target="_blank"
                                rel="noopener noreferrer"
                                whileHover={{ scale: 1.1, y: -4, rotate: 4 }}
                            ...
                            <motion.a
                                ...
                                className="social-btn social-btn--twitter glass-card"
